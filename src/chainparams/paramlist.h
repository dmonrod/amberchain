...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "rootstreamopen"                       , "root-stream-open"                       ,
                   MC_PRM_BOOLEAN  | MC_PRM_USER | MC_PRM_CLONE                 , -1  ,       0,          0,         0, 0.0, 10006, 0, "-mc-rootstreamopen",
                   "chainistestnet","",
    ...
    { "anyonecanconnect"                  , "anyone-can-connect"                ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10001, 0, "-mc-anyonecanconnect",
                   "anyonecansend","Global permissions",
                   "Anyone can connect, i.e. a publicly readable blockchain."},
    { "anyonecansend"                     , "anyone-can-send"                   ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10001, 0, "-mc-anyonecansend",
                   "anyonecanreceive","",
                   "Anyone can send, i.e. transaction signing not restricted by address."},
    { "anyonecanreceive"                  , "anyone-can-receive"                ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 10001, 0, "-mc-anyonecanreceive",
    ...
    { "miningdiversity"                   , "mining-diversity"                   , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_DECIMAL , -1,    600000,          0,   1000000, 0.0, 10001, 0, "-mc-miningdiversity",
    ...
    { "adminconsensusupgrade"               , "admin-consensus-upgrade"               , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_DECIMAL , -1,    300000,          0,   1000000, 0.0, 10008, 0, "-mc-adminconsensusupgrade",
                   "adminconsensusadmin","",
    ...
    { "adminconsensusactivate"                , "admin-consensus-activate"              , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_DECIMAL , -1,    300000,          0,   1000000, 0.0, 10003, 0, "-mc-adminconsensusactivate",            
                   "adminconsensusmine","",
                   "<admin-consensus-activate>*<active admins> to change activate perms."},
    { "adminconsensusmine"                , "admin-consensus-mine"              , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_DECIMAL , -1,    300000,          0,   1000000, 0.0, 10001, 0, "-mc-adminconsensusmine",            
...
*/                   
    { "firstblockreward"                 , "first-block-reward"             ,
                   MC_PRM_INT64   | MC_PRM_USER | MC_PRM_CLONE                  , -1,        200000000000000000,         -1,1000000000000000000, 0.0, 10002, 0, "-mc-genesisblockreward",
    ...
    { "maximumperoutput"                     , "maximum-per-output"                     , 
                   MC_PRM_INT64   | MC_PRM_USER | MC_PRM_CLONE                  , -1,         200000000000000000,         0,1000000000000000000, 0.0, 10001, 0, "-mc-maximumperoutput",
                   "minimumrelayfee","",
